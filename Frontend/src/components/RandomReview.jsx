...
const RandomReview = () => {
    ...
    const fetchBusinessData = async () => {
        try {
            const response = await axios.get(`${baseUrl}/businesses/get/${businessId}`);
    ...
    const updateStatus = async () => {
        try {
            const response = await axios.put(`${baseUrl}/businesses/update-review-status/${businessId}/${randomReview.Description}`);
